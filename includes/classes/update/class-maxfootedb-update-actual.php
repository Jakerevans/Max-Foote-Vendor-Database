<?php
/**
 * Maxfoote Maxfoote_Toplevel_Update_Actual Class
 *
 * @author   Jake Evans
 * @category admin
...
if ( ! class_exists( 'Maxfoote_Toplevel_Update_Actual', false ) ) :
	/**
	 * Maxfoote_Toplevel_Update_Actual Class.
	 */
	class Maxfoote_Toplevel_Update_Actual {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			if ( $test_name === $wpdb->get_var( "SHOW TABLES LIKE '$test_name'" ) ) {
				...
				$this->extension_settings = $wpdb->get_row( 'SELECT * FROM ' . $wpdb->prefix . 'maxfootedb_settings' );
