...
/* CONSTANT DEFINITIONS */
	...
	define( 'MAXFOOTEDB_NONCES_ARRAY',
		wp_json_encode(array(
			...
			'adminnonce5' => 'maxfootedb_admin_bulk_csv_upload_action_callback',			
		))
	);
...
/* FUNCTIONS FOUND IN CLASS-WPPLUGIN-AJAX-FUNCTIONS.PHP THAT APPLY PLUGIN-WIDE */
	...
	// For bulk-uploading by CSV from the admin dashboard.
	add_action( 'wp_ajax_maxfootedb_admin_bulk_csv_upload_action', array( $maxfoote_ajax_functions, 'maxfootedb_admin_bulk_csv_upload_action_callback' ) );
